...
//     uint64_t poly_degree = parms.poly_modulus_degree(); 
//     uint64_t coeff_mod_bits = 0;
//     for (auto coeff_mod : parms.coeff_modulus()){
//       coeff_mod_bits += coeff_mod.bit_count();
//     }
//     assert(coeff_mod_bits/base_log2 == l);
    
//     uint128_t base = 2 << base_log2;
//     GSWCiphertext result;
//     for (int i = 1; i <= l; i++) {
//       std::vector<uint128_t> row(0, poly_degree);
//       row[0] = 
//     }
